...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" show-ref "0.6.3"
  WORKING_DIRECTORY "G:/gitRepositories/GAMES102Study/build/_deps/ucmake-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("0.6.3" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/0.6.3")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'G:/gitRepositories/GAMES102Study/build/_deps/ucmake-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'G:/gitRepositories/GAMES102Study/build/_deps/ucmake-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
