...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" show-ref "0.1.6"
  WORKING_DIRECTORY "G:/gitRepositories/GAMES102Study/build/_deps/ugraphviz-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("0.1.6" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/0.1.6")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'G:/gitRepositories/GAMES102Study/build/_deps/ugraphviz-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'G:/gitRepositories/GAMES102Study/build/_deps/ugraphviz-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
